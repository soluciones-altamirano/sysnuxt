<template>
  ...
  <!--            Tabla de datos
  ------------------------------------------------------------------------>
  <v-data-table :headers="headers" :items="empresas" sort-by="calories" class="elevation-1" :loading="loadingDatos" loading-text="Cargando datos, por favor espere...">
      ...
      <v-toolbar flat color="dark">
        ...
        <v-dialog v-model="dialog" max-width="800px">
          ...
          <template v-slot:activator="{ on }">
            <v-btn color="primary" light class="mb-2" v-on="on">Nuevo Empresa</v-btn>
          </template>
              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field  v-model="editedItem.slogan" label="Slogan"></v-text-field>
                    </v-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedItem.id === 0 ? 'Nuevo Empresa' : 'Editar Empresa'
            },
            editando(){
        ...
        methods: {
            ...
            async deleteItem (item) {
                ...
                const res = confirm('Esta seguro de eliminar el Empresa '+this.editedItem.name+' ?');
